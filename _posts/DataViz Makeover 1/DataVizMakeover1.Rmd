...
![Figure 1: Proposed Graphical Representation](Image/sketch_1.jpg){width=75%}
...
![Figure 3: Connecting to data source](Image/Clean_1.jpg){width=75%}

3. Three tables corresponding to three worksheet is the excel is extracted. 

![Figure 4: Connecting to data source](Image/Clean_2.jpg){width=75%}
...
![Figure 6: Filter out the relevant period](Image/Clean_5.jpg){width=75%}
...
![Figure 8: Changing the data type](Image/Clean_7.jpg){width=75%}

8. Extract the table and save it as T1(outputFile)

![Figure 9: Extract the table](Image/Clean_8.jpg){width=100%}
...
![Figure 12: Inner join](Image/Clean_10.jpg){width=100%}

15. Create a new calculated field to convert imports and exports into billions scale.
![Figure 13: Customising filter workspace](Image/Clean_22.jpg){width=100%}
...
![Figure 14: Customising filter workspace](Image/Clean_11.jpg){width=100%}
...
![Figure 15: Creating the plot](Image/Clean_12.jpg){width=100%}

19. Next, customisation of the x and y-axis can be done by double clicking on the axis. This ensures consistency in the axis inttervals.

![Figure 16: Customising the y-axis](Image/Clean_13.jpg){width=100%}

![Figure 17: Customising the x-axis](Image/Clean_14.jpg){width=100%}
...
![Figure 18: Creating a new measure](Image/Clean_15.jpg){width=100%}

23. A pop-up will appear. Key in "[Exports] - [Imports]" in the space provided to derive net exports. 

![Figure 19: Entering formula for Net Exports](Image/Clean_16.jpg){width=50%}
...
![Figure 20: Creating the plot](Image/Clean_17.jpg){width=100%}
...
![Figure 21: Creating an additional line chart](Image/Clean_23.jpg){width=75%}

26. Next, I have created 2 more measures, to differentiate between positive net exports (trade surplus) and negative net exports (trade deficit). This is done by creating a new calculated field, and the IF function.

![Figure 22: Creating additional measures for positive and negative differentiation](Image/Clean_24.jpg){width=75%}
27. Finally, I have annotated the % change in net exports between 2019 and 2020.

![Figure 23: Creating additional measures for positive and negative differentiation](Image/Clean_25.jpg){width=75%}

## 5.4. Dashboarding - Putting everything together

28. Create new dashboard worksheet, and the individual charts created previously would appear on the left side Tableau. 

![Figure 24: Creating the dashboard](Image/Clean_18.jpg){width=100%}

29. For this dashboard, I have decided to use PowerPoint (1600 x 900) as the size and used the floating method to position the different visualisations. 

![Figure 25: Setting the dashboard](Image/Clean_20.jpg){width=75%}
...
![Figure 26: Final Dashboard](Image/Clean_21.jpg){width=100%}
